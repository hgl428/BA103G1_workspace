...
<%
	...
	// 	List<PetImageVO> list = picSvc.getPetPic(121);
	pageContext.setAttribute("picSvc", picSvc);
	//把圖老大叫出來
			...
			<div class="left-sidebar col-xs-12">
				<div class="row">
					...
					<div class="conditions-area">
						...
						<div class="col-sm-12">
							<label for="petPosition"></label> <input type="text" name=""
								placeholder="請輸入搜尋關鍵字">
						</div>

						<div class="col-sm-12">
							<label for="petPosition">動物類型</label> <select>
						...
						<div class="col-sm-12">
							<label for="petPosition">動物所在縣市</label> <select
								name="propaddress" id="petPosition">
								<option value="">請選擇</option>
						...
						<div class="col-sm-12">
							<label for="petAge">年齡</label> <select id="petAge">
								<option value="">請選擇</option>
							...
							<div class="more-area">
								...
								<div class="col-sm-10">
									<div class="row">
										<!-- 這裡有更多條件，請條列有哪些篩選條件。 -->
										<div class="col-sm-12">
											<label for="petPosition">動物性別</label> <select>
												<option value="">請選擇</option>
					...
					<div class="row">
						<div class="b-photo-gallery">
							...
							<div class="main-photo">
								<img id="show-image"
									src="<%=request.getContextPath()%>/JSP/IpetB/PetImage.do?petNo=${petviewVO.petNo}&index=1
										">
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="b-title-area left">
							<span>${petviewVO.speciesName}</span>
							<h2>${petviewVO.petTitle}</h2>
						</div>
					</div>
					<div class="b-detail">
						<!-- 動物現況簡述 200字元 start-->
						<div class="description">
							<p>${petviewVO.situation}</p>
						</div>
						<!-- 動物現況簡述 end-->
						<!-- 基本資料 start -->
						<div class="info">
							...
							<div class="item col-sm-6">
								<p>
									<span class="title">動物編號：</span> <span class="text">${petviewVO.petNo}</span>
								</p>
							</div>
							<div class="item col-sm-6">
								<p>
									<span class="title">動物姓名：</span> <span class="text">${petviewVO.petName}</span>
								</p>
							</div>
							<div class="item col-sm-6">
								<p>
									<span class="title">性別：</span> <span class="text">${petviewVO.petSex}</span>
								</p>
							</div>

							<div class="item col-sm-6">
								<p>
									<span class="title">毛色：</span> <span class="text">${petviewVO.petColor}</span>
								</p>
							</div>
							<div class="item col-sm-6">
								<p>
									<span class="title">動物品種：</span> <span class="text">${petviewVO.breedName}</span>
								</p>
							</div>
							<div class="item col-sm-6">
								<p>
									<span class="title">動物體型：</span> <span class="text">${petviewVO.petSize}</span>
								</p>
							</div>
							<div class="item col-sm-6">
								<p>
									<span class="title">年齡：</span> <span class="text">${petviewVO.petAge}</span>
								</p>
							</div>
							<div class="item col-sm-6">
								<p>
									<span class="title">送養地址：</span> <span class="text">${petviewVO.petPosition}</span>
								</p>
							</div>

							<div class="item col-sm-6">
								<p>
									<span class="title">晶片：</span> <span class="text">${petviewVO.petIc}</span>
								</p>
							</div>
							<div class="item col-sm-6">
								<p>
									<span class="title">絕育：</span> <span class="text">${petviewVO.TNR}</span>
								</p>
							</div>
							<div class="clearfix"></div>
							<div class="item col-sm-6">
								<p>
									<span class="title">送養日期：</span> <span class="text">${petviewVO.petDate}</span>
								</p>
							</div>
						</div>
						<!-- 基本資料 end -->
